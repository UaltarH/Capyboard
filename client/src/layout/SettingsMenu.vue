<template>
  <ButtonGroup class="flex justify-center w-full settings-menu">
    <Button id="dark-mode-toggle" class="dark-mode" aria-label="dark mode button" outlined @click="useDarkMode">
      <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="hidden dark:block fill-blue-200">
        <title>Dark Mode - Moon and Stars</title>
    ...
    <AppConfigurator />
    <Button v-ripple outlined class="inline-flex justify-center items-center">
      <OverlayBadge value="2" class="inline-flex justify-center items-center">
        <i class="pi pi-bell"/>
      </OverlayBadge>
    </Button>
  </ButtonGroup>
